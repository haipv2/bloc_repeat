...
import 'package:flt_bloc_repeat/models/movie_filters.dart';
import 'package:flt_bloc_repeat/models/movie_page_result.dart';
...
class MovieCatalogBloc implements BlocBase {
  ...
  ///
  BehaviorSubject<int> _totalMoviesController = BehaviorSubject<int>();
  BehaviorSubject<List<int>> _releaseDatesController = BehaviorSubject<List<int>>();
  BehaviorSubject<int> _genreController = BehaviorSubject<int>();
  ...
  ///
  BehaviorSubject<MovieFilters> _filtersController = BehaviorSubject<MovieFilters>()..startWith(MovieFilters(genre: 28, minReleaseDate: 2000, maxReleaseDate: 2005));
